...
public class KangaParserTokenManager implements KangaParserConstants {
    ...
    public static final String[] jjstrLiteralImages = {
            ...
            "\110\101\114\114\117\103\101\124\105",
            "\123\120\111\114\114\105\104\101\122\107",
            "\105\116\104", "\116\117\117\120", "\115\117\126\105",
            "\103\101\114\114", "\105\122\122\117\122", "\120\122\111\116\124",
            "\102\105\107\111\116", "\122\105\124\125\122\116",
            "\112\125\115\120", "\103\112\125\115\120",
            "\110\123\124\117\122\105", "\110\114\117\101\104",
            "\101\114\117\101\104", "\101\123\124\117\122\105",
            "\120\101\123\123\101\122\107", "\115\105\115", "\124\105\115\120",
            "\101\122\107", "\172\145\162\157", "\141\164", "\166\60",
            "\166\61", "\141\60", "\141\61", "\141\62", "\141\63", "\164\60",
            "\164\61", "\164\62", "\164\63", "\164\64", "\164\65", "\164\66",
            "\164\67", "\163\60", "\163\61", "\163\62", "\163\63", "\163\64",
            "\163\65", "\163\66", "\163\67", "\164\70", "\164\71", "\153\60",
            "\153\61", "\147\160", "\163\160", "\146\160", "\162\141", null,
            null, null, null,};
    /**
     * Lexer state names.
     */
    ...
    public KangaParserTokenManager(JavaCharStream stream) {
        if (input_stream != null)
            throw new TokenMgrError("ERROR: Second call to constructor of " +
                    "static lexer. You must use ReInit() to initialize the " +
                    "static variables.", TokenMgrError.STATIC_LEXER_ERROR);
        input_stream = stream;
    }
    ...
    static private int jjMoveStringLiteralDfa1_0(long active0, long active1) {
        ...
        switch (curChar) {
            ...
            case 57:
                ...
                break;
            case 65:
                return jjMoveStringLiteralDfa2_0(active0, 0x400850000000L,
                        active1, 0L);
            case 69:
                ...
                return jjMoveStringLiteralDfa2_0(active0, 0x180c000000000L,
                        active1, 0L);
            case 73:
                return jjMoveStringLiteralDfa2_0(active0, 0x8800000L, active1
                        , 0L);
            case 74:
                return jjMoveStringLiteralDfa2_0(active0, 0x20000000000L,
                        active1, 0L);
            case 76:
                return jjMoveStringLiteralDfa2_0(active0, 0x180000400000L,
                        active1, 0L);
            case 78:
                return jjMoveStringLiteralDfa2_0(active0, 0x101000000L,
                        active1, 0L);
            case 79:
                return jjMoveStringLiteralDfa2_0(active0, 0x624000000L,
                        active1, 0L);
            case 80:
            ...
            case 82:
                ...
                return jjMoveStringLiteralDfa2_0(active0, 0x2003000000000L,
                        active1, 0L);
            case 83:
    ...
    static private int jjMoveNfa_0(int startState, int curPos) {
        ...
        for (; ; ) {
            ...
            ++curPos;
            if ((i = jjnewStateCnt) == (startsAt = 24 - (jjnewStateCnt =
                    startsAt)))
                return curPos;
            try {
                curChar = JavaCharStream.readChar();
    ...
    static private void jjAddStates(int start, int end) {
        do jjstateSet[jjnewStateCnt++] = jjnextStates[start];
        while (start++ != end);
    }
