...
public class KangaParser implements KangaParserConstants {
    ...
    static final public Goal Goal() throws ParseException {
        ...
        {
            if (true)
                return new Goal(n0, n2, n4, n5, n7, n9, n10, n12, n14, n15,
                        n17, n18, n20, n22);
        }
    ...
    static final public Procedure Procedure() throws ParseException {
        ...
        {
            if (true)
                return new Procedure(n0, n1, n3, n4, n6, n8, n9, n11, n13,
                        n14, n16, n17);
        }
        throw new Error("Missing return statement in function");
    }
    ...
    private static void jj_la1_init_0() {
        jj_la1_0 = new int[]{0x0, 0x0, 0x0, 0x0, 0x48c10000, 0x8c10000, 0x0,
                0x0,};
    }

    private static void jj_la1_init_1() {
        jj_la1_1 = new int[]{0x0, 0x7f3e, 0x0, 0x7f3e, 0xfff00000, 0x0,
                0xfff00000, 0xfff00000,};
    }

    private static void jj_la1_init_2() {
        jj_la1_2 = new int[]{0x80000, 0x80000, 0x80000, 0x0, 0xc0fff, 0x0,
                0xc0fff, 0xfff,};
    }
    ...
    static public void ReInit(java.io.InputStream stream, String encoding) {
        ...
        KangaParserTokenManager.ReInit(jj_input_stream);
        token = new Token();
        jj_ntk = -1;
        jj_gen = 0;
        for (int i = 0; i < 8; i++) jj_la1[i] = -1;
    ...
    static private Token jj_consume_token(int kind) throws ParseException {
        ...
        else token = token.next = KangaParserTokenManager.getNextToken();
        jj_ntk = -1;
        if (token.kind == kind) {
            jj_gen++;
            return token;
    ...
    static final public Token getToken(int index) {
        ...
        for (int i = 0; i < index; i++)
            ...
            else t = t.next = KangaParserTokenManager.getNextToken();
        return t;
    }
    ...
    static private int jj_ntk() {
        if ((jj_nt = token.next) == null)
            return (jj_ntk = (token.next =
                    KangaParserTokenManager.getNextToken()).kind);
        else
