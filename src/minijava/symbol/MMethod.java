...
public class MMethod extends MSymbol {
    ...
    public void AddArg(MVar arg) {
        if (args.containsKey(arg.name))
            ErrorHandler.Error("\33[31mArg \33[32;4m" + arg.name
    ...
    /**
     * Check whether the args list from a method is IDENTICAL (in number and
     * type)
     * to the args of this
     *
    ...
    public boolean CheckArgs(LinkedHashMap<String, MVar> _args) {
        ...
        while (it.hasNext()) {
            ...
            if (!entry.getValue().type.equals(_entry.getValue().type))
                return false;
        }
    ...
    public boolean CheckArgs(ArrayList<MType> _args) {
        ...
        while (it.hasNext()) {
            ...
            if (argType.CheckType(_it.next()) != null) return false;
        }
        return true;
    }
    ...
    public void CheckUse() {
        for (MVar var : vars.values())
            if (!var.used)
                ErrorHandler.Warn("\33[33mVariable \33[32;4m" + var.name
                        + "\33[0m\33[33m is not used\33[0m", var.row, var.col);
    }
    ...
    public boolean CheckInit(MVar var) {
        return var.initiated || args.containsValue(var);
    }

    public void Print(String indent) {
        System.out.print(indent + "\33[33;4m" + type + "\33[0m \33[34;4m"
                + name + "\33[0m(");
    ...
    public String ErrInfo() {
        ...
        /* print args */
        Iterator<Map.Entry<String, MVar>> it = args.entrySet().iterator();
        if (it.hasNext()) info = info + "\33[33;4m" + it.next().getValue().type;
        while (it.hasNext())
