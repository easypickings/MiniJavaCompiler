...
public class MainClass implements Node {
    ...
    public MainClass(NodeToken n0, Identifier n1, NodeToken n2, NodeToken n3,
                     NodeToken n4, NodeToken n5, NodeToken n6, NodeToken n7,
                     NodeToken n8, NodeToken n9, NodeToken n10,
                     Identifier n11, NodeToken n12, NodeToken n13,
                     NodeListOptional n14, NodeListOptional n15,
                     NodeToken n16, NodeToken n17) {
        f0 = n0;
        f1 = n1;
        f2 = n2;
        f3 = n3;
    ...
    public MainClass(Identifier n0, Identifier n1, NodeListOptional n2,
                     NodeListOptional n3) {
