/* Generated By:JavaCC: Do not edit this line. JavaCharStream.java Version 4
.1 */
...
public class JavaCharStream {
    ...
    public JavaCharStream(java.io.Reader dstream,
        ...
        if (inputStream != null)
            throw new Error("\n   ERROR: Second call to the constructor of a " +
                    "static JavaCharStream.\n" +
                    "       You must either use ReInit() or set the JavaCC " +
    ...
    static protected void AdjustBuffSize() {
        if (available == bufsize) if (tokenBegin > 2048) {
            bufpos = 0;
...
/* JavaCC - OriginalChecksum=67bc764deb26e7a653e0b83168fac4e3 (do not edit
this line) */
