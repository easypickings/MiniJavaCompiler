 ...
 * @LastEditors  : Can Su
 * @LastEditTime : 2020-03-05 22:14:12
...
public class BuildSymbolTableVisitor extends GJDepthFirst<MSymbol, MSymbol> {
   ...
   public MSymbol visit(MainClass n, MSymbol argu) {
      ...
      if (!MTypeList.AddClass(mainClass)) {
         String err = "\33[31mCLASS \33[33;3m" + mainClass.getName() + "\33[0m\33[31m DUPLICATE DECLARATION\33[0m";
         ErrorHandler.Error(err, mainClass.getRow(), mainClass.getCol());
         return _ret;
      }

      MMethod mainMethod = new MMethod("main", "void", mainClass, mainClass.getRow() + 1, mainClass.getCol() + 27);
      /** add main method to mainClass */
      if (!mainClass.AddMethod(mainMethod)) {
         String err = "\33[31mMETHOD \33[33;3m" + mainMethod.getName() + "\33[0m\33[31m DUPLICATE DECLARATION\33[0m";
      ...
      if (!mainMethod.AddArg(arg)) {
         String err = "\33[31mARG \33[33;3m" + arg.getName() + "\33[0m\33[31m DUPLICATE DECLARATION\33[0m";
         ErrorHandler.Error(err, arg.getRow(), arg.getCol());
         return _ret;
      }
   ...
   public MSymbol visit(ClassDeclaration n, MSymbol argu) {
      ...
      if (!MTypeList.AddClass(simpleClass)) {
         String err = "\33[31mCLASS \33[33;3m" + simpleClass.getName() + "\33[0m\33[31m DUPLICATE DECLARATION\33[0m";
         ErrorHandler.Error(err, simpleClass.getRow(), simpleClass.getCol());
         return _ret;
      }
   ...
   public MSymbol visit(ClassExtendsDeclaration n, MSymbol argu) {
      ...
      /** add class to MTypeList */
      if (!MTypeList.AddClass(extendClass)) {
         String err = "\33[31mCLASS \33[33;3m" + extendClass.getName() + "\33[0m\33[31m DUPLICATE DECLARATION\33[0m";
         ErrorHandler.Error(err, extendClass.getRow(), extendClass.getCol());
         return _ret;
      }
   ...
   public MSymbol visit(VarDeclaration n, MSymbol argu) {
      ...
      String err = "\33[31mVARIABLE \33[33;3m" + var.getName() + "\33[0m\33[31m DUPLICATE DECLARATION\33[0m";
      if (argu instanceof MClass) {
         /** add var to argu(owner) */
         if(!((MClass) argu).AddVar(var)) {
            ErrorHandler.Error(err, var.getRow(), var.getCol());
            return _ret;
         }
      } else if (argu instanceof MMethod) {
         /** add var to argu(owner) */
         if(!((MMethod) argu).AddVar(var)) {
            ErrorHandler.Error(err, var.getRow(), var.getCol());
            return _ret;
         }
      } else { /** unlikely to fall into this */
         ErrorHandler.Error("ILLEGAL POSITION OF VARIABLE DECLARATION\33[0m", id.getRow(), id.getCol());
         return _ret;
      }
   ...
   public MSymbol visit(MethodDeclaration n, MSymbol argu) {
      ...
      if(!((MClass) argu).AddMethod(method)) {
         String err = "\33[31mMETHOD \33[33;3m" + method.getName() + "\33[0m\33[31m DUPLICATE DECLARATION\33[0m";
         ErrorHandler.Error(err, method.getRow(), method.getCol());
         return _ret;
      }
